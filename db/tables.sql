...
INSERT,
UPDATE,
SELECT ON TABLE ecommerce.order_statuses TO robotfw;

INSERT INTO
    ecommerce.order_statuses (status)
VALUES ('New'),
    ('Approved'),
    ('Voided'),
    ('Closed');
...
GRANT
UPDATE,
SELECT, DELETE, INSERT ON TABLE ecommerce.items TO robotfw;

INSERT INTO
    ecommerce.items (id, "name", price)
VALUES (
        '41c8ba6b-d87d-4186-b5a7-67e0859f9930',
        'AsRock B650M PG Riptide AM5',
        704.99
    ),
    (
        '8989d984-b4d2-4593-bc46-d6d041691b03',
        'G.Skill DDR5-6000 32GB (2x16GB) CL36',
        509.00
    ),
    (
        '42fe5cab-1d68-4dcd-83f3-9210a705bcec',
        'Thermalright contact frame AM5',
        52.50
    ),
    (
        'c3688919-9a8b-41f3-a7f6-71a070c525aa',
        'AMD Ryzen 5 7600 3.8GHz BOX',
        931.06
    );
...
GRANT
UPDATE,
SELECT, DELETE, INSERT ON TABLE ecommerce.customers TO api;

GRANT
UPDATE,
SELECT, DELETE, INSERT ON TABLE ecommerce.customers TO robotfw;
...
CREATE TABLE IF NOT EXISTS ecommerce.orders (
    ...
    CONSTRAINT "FK_ORDERS_CUSTOMER" FOREIGN KEY (customer_id) REFERENCES ecommerce.customers (id) MATCH SIMPLE ON UPDATE NO ACTION ON DELETE CASCADE,
...
GRANT
UPDATE,
SELECT, DELETE, INSERT ON TABLE ecommerce.orders TO api;

GRANT
UPDATE,
SELECT, DELETE, INSERT ON TABLE ecommerce.orders TO robotfw;
...
CREATE TABLE IF NOT EXISTS ecommerce.order_items (
    ...
    CONSTRAINT "FK_ORDER_ITEM_ITEM" FOREIGN KEY (item_id) REFERENCES ecommerce.items (id) MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION,
...
GRANT
UPDATE,
SELECT, DELETE, INSERT ON TABLE ecommerce.order_items TO api;

GRANT
UPDATE,
SELECT, DELETE, INSERT ON TABLE ecommerce.order_items TO robotfw;
