...
def init_db_connection(db_url: str, pool_config: dict[str, Any] | None = None) -> None:
    """
    ...
    Example:
        init_db_connection("postgresql://user:password@localhost/dbname", {"min_size": 1, "max_size": 20})
    """
    global __pool
